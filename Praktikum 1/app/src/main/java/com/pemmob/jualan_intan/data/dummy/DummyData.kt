package com.pemmob.jualan_intan.data.dummy
...
object DummyData {
    val categories = listOf(
        Category(id = 1, name = "Makanan", description = "Aneka Makanan Lokal", products_count = 6),
    ...
    val products = listOf(
        ...
        Product(16, 1, categories[0], "Katsu", "Makanan Gen Z", 12000.0, 10, "produk_baru"),
